...
suite( 'Extension Test Suite', () => {
  ...
  test( 'get test title with whitespaces around test parenthesis', () => {
    ...
    assert.deepEqual( title, [ [ 'spaces', 4 ] ] );
  } );
  ...
  test( 'get test title with single quotes', () => {
    ...
    assert.deepEqual( title, [ [ 'single', 4 ] ] );
  } );

  test( 'detect serial as test keyword', () => {
    const title = getTestTitles( `
			serial('serialcase', t => {})
		` );

    assert.deepEqual( title, [ [ 'serialcase', 4 ] ] );
  } );
  ...
  test( 'get test title with double quote', () => {
    ...
    assert.deepEqual( title, [ [ 'double', 4 ] ] );
  } );
  ...
  test( 'get test title with double quote with spaces', () => {
    ...
    assert.deepEqual( title, [ [ 'double with spaces', 4 ] ] );
  } );
  ...
  test( 'get test title with concatenation', () => {
    ...
    assert.deepEqual( title, [ [ 'testtitle', 4 ] ] );
  } );
  ...
  test( 'get test title in another line', () => {
    ...
    assert.deepEqual( title, [ [ 'test title', 4 ] ] );
  } );
  ...
  test( 'get test title in backticks', () => {
    ...
    assert.deepEqual( title, [ [ 'backtick', 4 ] ] );
  } );
  ...
  test( 'get test title in backticks multiline', () => {
    ...
    assert.deepEqual( title, [ [ 'backtick multiline', 4 ] ] );
  } );
